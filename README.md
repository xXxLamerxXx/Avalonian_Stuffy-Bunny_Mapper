...
1. Скачайте последнюю версию из [релизов](https://github.com/xXxLamerxXx/Avalonian_Stuffy-Bunny_Mapper/releases) (архив `AvalonMapper.zip` или `AvalonMapper.rar`).
